...
<script>
/* eslint-disable */
import { matchesSelectorToParentElements, addEvent, removeEvent } from '@/utils/drag/dom'
...
export default {
  ...
  methods: {
    ...
    getParentSize () {
      if (this.parent === true) {
        let style = window.getComputedStyle(this.$el.parentNode, null)
        return [
    ...
    async handleUp (e) {
      ...
      if (this.resizing) {
        this.resizing = false
        await this.conflictCheck() && this.snapCheck()
